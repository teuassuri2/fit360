...
public function storeApi(StoreReceitaCategoriaRequest $request) {if ($request->isMethod("post")) {$receitaCategoria = $this->receitaCategoriaService->create($request->validated());return response()->json(new ReceitaCategoriaJsonResource($receitaCategoria), 200);}
}
...
public function store(StoreReceitaCategoriaRequest $request) {if ($request->isMethod("post")) {$receitaCategoria = $this->receitaCategoriaService->create($request->validated());}
