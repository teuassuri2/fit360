...
public function storeApi(StoreJejumIntermitenteProgramacaoRequest $request) {if ($request->isMethod("post")) {$jejumIntermitenteProgramacao = $this->jejumIntermitenteProgramacaoService->store($request->validated());return response()->json(new JejumIntermitenteProgramacaoJsonResource($jejumIntermitenteProgramacao), 200);}
}
...
public function store(StoreJejumIntermitenteProgramacaoRequest $request) {if ($request->isMethod("post")) {$jejumIntermitenteProgramacao = $this->jejumIntermitenteProgramacaoService->store($request->validated());}
